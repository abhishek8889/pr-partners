                ...
                @foreach ($press_release as $release)
                    ...
                    <tr class="nk-tb-item">
                        ...
                        <td class="nk-tb-col">
                            ...
                            <div class="user-card">
                                ...
                                <span class="tb-odr-total">
                                    <input type="text" data-id="{{ $release->id ?? ''}}" old-name="{{$release->title ?? ''}}"
                                        name="edittitle{{ $release->id ?? ''}}" class="form-control edittitle{{ $release->id ?? ''}}"
                                        disabled value="{{ $release->title ?? ''}}">
                                </span>                                </div>
                            </div>
                        </td>
                        ...
                        <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                <span class="tb-odr-total">
                                    <input type="number" data-id="{{ $release->id ?? ''}}" old-name="{{$release->price ?? ''}}"
                                        name="editprice{{ $release->id ?? ''}}" class="form-control editprice{{ $release->id ?? ''}}"
                                        disabled value="{{ $release->price ?? ''}}">
                                </span> 
                        </td>
                        ...
                        <div class="dropdown drop{{$release->id}}">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-xs">
                                <ul class="link-list-plain">
                                    <li><a class="text-primary edit" data-id="{{ $release->id ?? '' }}">Edit</a></li>
                                    <li><a class="text-danger remove" data-id="{{ $release->id ?? '' }}">Remove</a></li>
                                </ul>
                            </div>
                        </div>
